...
class FaceAging(object):
    ...
    def train(self,
        ...
        self.loss_EG = self.EG_loss + 0.0001 * self.G_img_loss + 0.0001 * self.E_z_loss + 0.0001 * self.tv_loss
        ...
        self.D_z_optimizer = tf.train.GradientDescentOptimizer(
            learning_rate=EG_learning_rate
            # beta1=beta1
        ).minimize(
            loss=self.loss_Dz,
        ...
        self.D_img_optimizer = tf.train.GradientDescentOptimizer(
            learning_rate=EG_learning_rate
            # beta1=beta1
        ).minimize(
            loss=self.loss_Di,
